...
import { Alert, PermissionsAndroid, Platform, StyleSheet, Text, TouchableOpacity, TouchableWithoutFeedback, View } from 'react-native';

// Solicitar permiso para usar el micrófono en Android
...
const App = () => {
  ...
  useEffect(() => {
    requestMicrophonePermission(); // Solicita permisos al iniciar la aplicación
    guideUser();
  ...
  const startListening = async () => {
    try {
      await Voice.start('es-MX'); // Inicia el reconocimiento de voz en español
