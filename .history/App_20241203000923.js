...
const App = () => {
  ...
  const guideUser = () => {
    speak(
      'Hola, soy tu app de visión asistida. Para iniciar sesion toca dos veces la parte superior de tu telefono para autenticarte o la parte inferior para registrar una nueva huella.'
    );
  };
