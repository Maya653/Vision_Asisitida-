...
import * as Permissions from 'expo-permissions'; // Importar para manejar permisos
...
const App = () => {
  ...
  const authenticateUser = async () => {
    console.log('Iniciando autenticación...'); // Depuración
  ...
  const onSpeechResults = (event) => {
    ...
    console.log('Resultados de voz:', result); // Depuración
  ...
  const onSpeechError = (event) => {
    console.log('Error de voz:', event); // Depuración
      ...
      <View style={styles.card}>
        {!isAuthenticated ? (
          <>
            ...
            <Button title="Autenticarse" onPress={authenticateUser} />
          </>
        ) : (
          <>
