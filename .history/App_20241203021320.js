...
const App = () => {
  ...
  const guideUser = () => {
    speak(
      'Hola, soy tu app de visión asistida. Toca dos veces la parte superior para autenticarte o la parte inferior para registrar una nueva huella. También, si necesitas ayuda, toca dos veces el botón de volumen hacia abajo.'
    );
  };
