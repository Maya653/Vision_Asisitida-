...
const App = () => {
  ...
  const huellaData = 'huella_en_base64';  // La huella que se enviará
  ...
  const handleRegister = () => {
    registerFingerprint(userId, huellaData);  // Llama a la función del servicio para registrar la huella
  };
  ...
  return (
    <TouchableWithoutFeedback onPress={handleDoubleTap}>
      <View style={styles.container}>
        ...
        <Button title="Registrar Huella" onPress={handleRegister} /> {/* Agregado el botón para registrar huella */}
      </View>
