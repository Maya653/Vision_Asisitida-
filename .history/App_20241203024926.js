...
const App = () => {
  ...
  const activateVoiceAssistant = () => {
    speak('Asistente de voz activado. ¿En qué puedo ayudarte?'); // El asistente de voz responde
    // Aquí podrías agregar lógica para escuchar comandos del usuario
    // por ejemplo, usando `expo-speech` y alguna otra API para reconocer voz.
  };
