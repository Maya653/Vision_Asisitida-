...
const App = () => {
  ...
  const handleFingerprintRegistration = async () => {
    ...
    if (result.success) {
      ...
      console.log('No se pudo registrar la huella. Intenta nuevamente.');
    }
  };
  ...
  const authenticateUser = async () => {
    ...
    console.log('Solicitando autenticación de huella dactilar...');
    ...
    if (hasHardware) {
      ...
      if (result.success) {
        ...
        console.log('Autenticación exitosa. Funcionalidades habilitadas.');
      } else {
