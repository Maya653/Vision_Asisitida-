...
const App = () => {
  ...
  const guideUser = () => {
    speak(
      "Bienvenido a la aplicación. Para comenzar, elija si desea iniciar sesión o registrar un nuevo usuario."
    );
  };
      ...
      <View style={styles.card}>
        {!isAuthenticated ? (
          <>
            ...
            >
              <Text style={styles.featureText}>Iniciar Sesión</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.actionButton}
              onPress={registerNewUser}
            >
              <Text style={styles.featureText}>Registrar Nuevo Usuario</Text>
            </TouchableOpacity>
          </>
        ) : (
          <>
