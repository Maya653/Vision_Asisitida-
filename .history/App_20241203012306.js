    ...
    <View style={styles.container}>
      <TouchableWithoutFeedback onPress={(e) => handleTap(e)}>
        <View style={styles.touchableArea}>
          <Text>¡Toca la pantalla para interactuar!</Text>
        </View>
      </TouchableWithoutFeedback>
      <Text>Tu ubicación: {location ? `Latitud ${location.coords.latitude}, Longitud ${location.coords.longitude}` : 'Cargando ubicación...'}</Text>
      <Text>Destino: {destination ? `Latitud ${destination.latitude}, Longitud ${destination.longitude}` : 'Cargando destino...'}</Text>
