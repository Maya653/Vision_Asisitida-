  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        {isAuthenticated ? (
          <>
            <Text style={styles.welcomeText}>¡Bienvenido a Vision Asistida!</Text>
            <Image
              source={require('./assets/success-icon.png')} // Agrega un ícono en tu carpeta 'assets'
              style={styles.icon}
            />
          </>
        ) : (
          <>
            ...
            <Image
              source={require('./assets/loading-icon.gif')} // Un ícono o animación de carga en tu carpeta 'assets'
              style={styles.icon}
            />
          </>
        )}
